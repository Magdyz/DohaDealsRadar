 ...
 * Feedback Screen
 *
 * Allows users to submit feedback about EgyptDealRadar
 *
 * FEATURES:
...
fun FeedbackScreen(
    ...
    Scaffold(
                    ...
                    onClick = {
                        ...
                        if (email.isNotBlank()) {
                            ...
                            if (!emailRegex.matches(email)) {
                                errorMessage = context.getString(R.string.feedback_error_invalid_email)
                                return@Button
                            }
                        }
                        ...
                        if (feedbackText.length > maxCharacters) {
                            errorMessage = context.getString(R.string.feedback_error_too_long, maxCharacters)
                            return@Button
                        }
                            ...
                            try {
                                    ...
                                    onFailure = { error ->
                                        ...
                                        errorMessage = when {
                                            error.message?.contains("email", ignoreCase = true) == true ->
                                                context.getString(R.string.feedback_error_email_issue)
                                            error.message?.contains("network", ignoreCase = true) == true ->
                                                context.getString(R.string.common_error_network)
                                            else ->
                                                context.getString(R.string.feedback_error_submit)
                                        }
                                    }
                                )
                            } catch (e: Exception) {
                                ...
                                errorMessage = when {
                                    ...
                                    e.message?.contains("timeout", ignoreCase = true) == true ->
                                        context.getString(R.string.common_error_timeout)
                                    else ->
                        ...
                        Crossfade(
                            ...
                            Row(
                                ...
                                if (submitting) {
                                    ...
                                    Text(
                                        text = stringResource(R.string.common_submitting),
        ...
        when {
            ...
            Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                Text(
                    text = stringResource(R.string.feedback_text_label),
                    style = MaterialTheme.typography.bodyMedium.copy(
                        fontWeight = FontWeight.Medium,
                        fontSize = 14.sp
                    ),
                ...
                OutlinedTextField(
                    ...
                    placeholder = {
                        Text(
                            text = stringResource(R.string.feedback_text_placeholder),
                            fontSize = 16.sp,
                            color = Color(0xFF9CA3AF)
                        )
                    },
                    ...
                    supportingText = {
                        Text(
                            text = stringResource(R.string.feedback_char_count, feedbackText.length, maxCharacters),
...
private fun FeedbackSendingContent() {
    ...
    Column(
        ...
        Icon(
            ...
            contentDescription = stringResource(R.string.feedback_sending),
            modifier = Modifier
                .size(120.dp)
                .scale(scale)
        ...
        Text(
            text = stringResource(R.string.feedback_sending),
    ...
    AnimatedVisibility(
        ...
        Column(
                ...
                Surface(
                    ...
                    Box(
                        ...
                        Icon(
                            ...
                            contentDescription = stringResource(R.string.feedback_sent),
            ...
            Column(
                ...
                // Subtitle
                Text(
                    text = stringResource(R.string.feedback_thank_you_message),
