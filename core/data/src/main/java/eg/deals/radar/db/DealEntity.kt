...
data class DealEntity(
    ...
    // ✨ Egypt 2.0
    val governorate: String? = null,          // e.g. "cairo", "all_egypt"
    val store: String? = null,                // e.g. "Amazon.eg" (known retailers)
    val userVote: String? = null,             // the user's own vote from the server: "hot" | "cold" | null
    val expiredVotes: Int = 0                 // "Is this deal expired?" confirmations
)
