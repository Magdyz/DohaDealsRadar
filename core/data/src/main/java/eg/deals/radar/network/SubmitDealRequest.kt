...
data class SubmitDealRequest(
    ...
    // ✨ Egypt 2.0
    val governorate: String = "all_egypt",
    @SerializedName("image_hash") val imageHash: String? = null,      // perceptual hash for duplicate detection
    @SerializedName("confirm_not_duplicate") val confirmNotDuplicate: Boolean = false
)